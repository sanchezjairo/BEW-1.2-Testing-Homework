...
class MainTests(unittest.TestCase):
    ...
    def test_book_detail_logged_out(self):
        ...
        # these are helper functions to create books, authors, user
        create_user()
        create_books()
        login(self.app, 'me1', 'password')

        #  Making a GET request to the URL /book/1, check to see that the
        # status code is 200
        ...
        self.assertIsNot('Favorite', response_text)
    ...
    def test_create_author(self):
        ...
        post_data = {
            "name": "Yami Sukehiro",
            "biography": "Captian of the black bulls",
        }
        ...
        self.assertEqual(created_author.name, "Yami Sukehiro")
        self.assertEqual(created_author.biography, "Captian of the black bulls")
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name="Cyberpunk").one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, "Cyberpunk")
    ...
    def test_favorite_book(self):
        create_books()
        create_user()
        # This makes you login as user me1
        login(self.app, "me1", "password")
        #This makes a post request to the favorite/1 route
        self.app.post("/favorite/1")
        #This verifys that the book with id one was added to the users favorite
    ...
    def test_unfavorite_book(self):
        ...
        #This Verifies that the book with id 1 was removed from the user's 
        # favorites
        user = User.query.filter_by(username="me1").one()
        self.assertIsNotNone(user)
        self.assertEqual(user.username, "me1")
        self.assertEqual(user.favorite_books[1].title, "" )
